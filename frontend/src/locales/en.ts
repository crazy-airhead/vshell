export default {
  ...
  connection: {
    ...
    moveConnection: 'Move Connection',
  ...
  settings: {
    ...
    clientSettingsTransfer: 'Settings Config',
    exportClientSettings: 'Export Settings Config',
    importClientSettings: 'Import Settings Config',
    clientSettingsExported: 'Settings config exported',
    clientSettingsImported: 'Settings config imported',
    clientSettingsExportFailed: 'Failed to export settings config: {error}',
    clientSettingsImportFailed: 'Failed to import settings config: {error}',
    clientSettingsInvalidFile: 'Not a valid vShell settings config file',
    uiFontFamily: 'Font',
